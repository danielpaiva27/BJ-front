...
const ROUND_PHASE_ALLOWED_ACTIONS: Record<GuidedRoundPhase, readonly GuidedRoundAction[]> = {
  ...
  INITIAL_DEAL: ["START_SEEN_CARDS_SETUP", "REGISTER_INITIAL_CARD", "ANALYZE_DECISION", "RESET_ROUND", "RESET_SHOE", "UNDO_CARD"],
  PLAYER_DECISION: ["START_SEEN_CARDS_SETUP", "ANALYZE_DECISION", "HIT", "STAND", "DOUBLE", "SPLIT", "SURRENDER", "RESET_ROUND", "RESET_SHOE", "UNDO_CARD"],
  PLAYER_HIT_PENDING: ["START_SEEN_CARDS_SETUP", "REGISTER_PLAYER_HIT", "RESET_ROUND", "RESET_SHOE", "UNDO_CARD"],
  PLAYER_DOUBLE_PENDING: ["START_SEEN_CARDS_SETUP", "REGISTER_PLAYER_DOUBLE", "RESET_ROUND", "RESET_SHOE", "UNDO_CARD"],
  DEALER_REVEAL_PENDING: ["START_SEEN_CARDS_SETUP", "REVEAL_DEALER_CARD", "RESET_ROUND", "RESET_SHOE", "UNDO_CARD"],
  DEALER_TURN: ["START_SEEN_CARDS_SETUP", "START_DEALER_DRAW", "SHOW_ROUND_RESULT", "RESET_ROUND", "RESET_SHOE", "UNDO_CARD"],
  DEALER_DRAW_PENDING: ["START_SEEN_CARDS_SETUP", "REGISTER_DEALER_DRAW", "RESET_ROUND", "RESET_SHOE", "UNDO_CARD"],
